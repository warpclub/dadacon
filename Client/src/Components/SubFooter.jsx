...
export default function SubFooter() {
  return (
    ...
    <div className='flex max-[568px]:flex-wrap justify-around w-full xl:w-5/6 mx-auto py-12'>
      ...
      <p className='text-black pt-4 min-[698px]:text-base text-[10px] pl-2 pr-4 flex items-center'>The story of the New Delhi's most famous bakery begins in 1996 on a quaint, cobblestone corner in the Connaught Place where Magnolia Bakery opened its doors for the first time. The sweet smell of cakes and cookies and bread and pudding tumbled out, wafting down the streets, beckoning all in.</p>
        </div>
